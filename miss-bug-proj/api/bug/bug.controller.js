...
export async function getBugs(req, res) {
    const { txt, minSeverity, labels, pageIdx, sortBy, orderBy } = req.query
    const filterBy = {
        txt,
...
export async function updateBug(req, res) {
    const { _id, title, severity, createdAt , labels } = req.body
    const bugToSave = { _id, title, severity, createdAt , labels }
    try {
